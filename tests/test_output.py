...
from judgement_ai.output import JsonResultsWriter, QuepidCsvWriter, result_to_dict
...
def test_quepid_csv_writer_appends_rows(tmp_path) -> None:
    path = tmp_path / "judgments.csv"
    writer = QuepidCsvWriter(path)
