...
def test_load_completed_pairs_rejects_csv(tmp_path) -> None:
    ...
    with pytest.raises(ValueError, match="canonical raw judgments JSON"):
        load_completed_pairs(output_path)
